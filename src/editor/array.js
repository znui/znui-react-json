...
var _array = React.createClass({
	...
	render: function(){
		...
		if(this.props.editable !== false) {
			_btns.push({ icon: 'faPlus', onClick: this.__onAdd });
		}
		...
		return (
			<div className={znui.react.classname("zr-json-editor-base zr-json-editor-object zr-json-editor-array", (this.state.fold?' fold':' unfold'), (this.props.required?' required':''))} style={znui.react.style(this.props.style)}>
				{
