...
var _array = React.createClass({
  ...
  render: function render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: znui.react.classname("zr-json-editor-base zr-json-editor-object zr-json-editor-array", this.state.fold ? ' fold' : ' unfold', this.props.required ? ' required' : ''),
